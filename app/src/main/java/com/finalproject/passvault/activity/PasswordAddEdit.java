...
public class PasswordAddEdit extends AppCompatActivity {
        ...
        if (activity.toLowerCase().equals("edit")) {
            ...
            databaseReference.child(id).addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                    ...
                    password.setText(DecryptMessage(passwordEdit.getPassword()));
            ...
            confirm.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (itemname.getText().toString().trim().isEmpty()) {
                        ...
                        update_pass.put("password", EncryptMessage(password.getText().toString()));
    ...
    @RequiresApi(api= Build.VERSION_CODES.O)
    public String EncryptMessage(String a_myMsg)
    {
        byte[] encryptedMsgByte = new byte[0];

        encryptedMsgByte = a_myMsg.getBytes(StandardCharsets.UTF_8);

        String myEncodedMsg = Base64.getEncoder().encodeToString(encryptedMsgByte);
        return myEncodedMsg;
    }
