package com.finalproject.passvault.adapter;
...
import com.finalproject.passvault.activity.PasswordView;
...
public class PasswordAdapter extends RecyclerView.Adapter<PasswordAdapter.MyViewHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull PasswordAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
